...
func TestBasic(t *testing.T) {
	...
	fmt.Printf("  ... Passed many pro same value \n")
	...
	fmt.Printf("  ... Passed many prop different valje\n")
...
func TestForget(t *testing.T) {
	...
	fmt.Printf("  [testForget]... Passed test forget\n")
}
...
func TestManyForget(t *testing.T) {
	...
	fmt.Printf("  ... Passed testManyforget\n")
}
...
//TODO TestForgetMem does not work
...
func TestMany(t *testing.T) {
	...
	//TODO change this and uncomment below
...
func TestManyUnreliable(t *testing.T) {
	...
	fmt.Printf("  ... Passed testManyUnrelaible\n")
}
...
func TestPartition(t *testing.T) {
	...
	for iters := 0; iters < 20; iters++ {
		seq++
		fmt.Println("In test with seq", seq)
		...
		fmt.Println("[TEST!!]Changing partition")
	...
	fmt.Printf(" [testPartitinos] ... Passed\n")
